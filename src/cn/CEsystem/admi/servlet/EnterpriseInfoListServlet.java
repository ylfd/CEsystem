...
@WebServlet("/enterpriseInfoListServlet")
public class EnterpriseInfoListServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<EnterpriseAllInfo> pb = service.findProjectByPage(currentPage,rows,condition);
...
//        System.out.println(pb.toString());
        ...
        //4.转发到list.jsp
        request.getRequestDispatcher("admi/enterpriseInfoList.jsp").forward(request,response);
    }
