...
@WebServlet("/lookFinishedServlet")
public class LookFinishedServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("enterprise/lookFinishedProject.jsp").forward(request,response);
    }
