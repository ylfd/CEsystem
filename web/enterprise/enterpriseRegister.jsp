...
<head>
    ...
    <script type="text/javascript">
        ...
        function validate1() {
            ...
            var reepassword = document.getElementById("reepassword");
            ...
            if (enumber.value.length > 10 || enumber.value.length < 4) {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" href="#">企业注册</a>
...
<div style="display:flex;justify-content:center; align-items:center;width: 100%;">
    <form onsubmit="return validate1();" action="${pageContext.request.contextPath}/enterpriseRegisterServlet"
          method="post">
        <%--<div class="container">--%>
            <table class="table" style="position: relative;left: 0;width: 100%;">
                <tr>
                    <td>企业账号:</td>
                    <td>
                        <input type="text" value="${map.enumber[0]}" name="enumber" id="enumber" placeholder="请输入企业账号！"
                ...
                <tr>
                    <td>企业名称:</td>
                    <td>
                        <input type="text" value="${map.ename[0]}" name="ename" id="ename" placeholder="请输入企业名称！"
                ...
                <tr>
                    <td>密码:</td>
                    <td>
                        <input type="password" name="epassword" id="epassword" placeholder="请填写企业密码！"
                ...
                <tr>
                    <td>确认密码:</td>
                    <td>
                        <input type="password" name="reepassword" id="reepassword" placeholder="请再次确认企业的密码！"
                               style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td>企业简介:</td>
                    <td>
                        <input type="text" value="${map.eintroduce[0]}" name="eintroduce" id="eintroduce"
                               placeholder="请填写企业的简介！" style="width:100%;" maxlength="100">
                    </td>
                </tr>
                <tr>
                    <td>地址:</td>
                    <td>
                        <input type="text" value="${map.eaddress[0]}" name="eaddress" id="eaddress"
                               placeholder="请填写企业的地址！" style="width:100%;" maxlength="50">
                    </td>
                </tr>
                <tr>
                    <td>联系方式:</td>
                    <td>
                        <input type="text" value="${map.ephone[0]}" name="ephone" id="ephone" placeholder="请填写企业的联系方式！"
                               style="width:100%;" maxlength="11">
                    </td>
                </tr>
                <br>
