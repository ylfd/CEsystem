...
<div style="width: 1000px;margin: 0px auto;display: table;">
    <form role="form" action="${pageContext.request.contextPath}/changeSelf_EnterpriseInfoServlet" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="eintroduce" value="${e.eintroduce}" class="form-control"  maxlength="50">
        </div>
        <div class="form-group">
