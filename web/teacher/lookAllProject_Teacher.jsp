    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="${pageContext.request.contextPath}/findStuByPageServlet?currentPage=1&rows=10&who=teacher">企业项目查看</a>
        ...
        <div style="float: left;margin-top: 20px">
            <form class="form-inline" action="${pageContext.request.contextPath}/findStuByPageServlet" method="post">
                <div class="form-group">
                    ...
                    <input hidden name="who" value="teacher">
        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${pb.list}" var="t" varStatus="s">
                <tr>
                    ...
                    <td>${t.publishtime}</td>
                    <td>${t.requirement}</td>
                    <td><a href="${pageContext.request.contextPath}/lookOneProjectServlet?id=${t.id}&who=teacher">查看详情</a></td>
                </tr>
            </c:forEach>
    ...
    <div style="margin-left: 15%;margin-bottom: 10%">
        <nav aria-label="Page navigation">
            <ul class="pagination pagination-lg">
                <li>
                    <a href="${pageContext.request.contextPath}/findStuByPageServlet?currentPage=${pb.currentPage -1}&rows=10&conpany=${condition.conpany[0]}&name=${condition.name[0]}&publishtime=${condition.publishtime[0]}&who=teacher"
                       aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    <c:if test="${pb.currentPage == i}">
                        <li class="active">
                            <a style="color: #0f0f0f;font-size: 25px" href="${pageContext.request.contextPath}/findStuByPageServlet?currentPage=${i}&rows=10&conpany=${condition.conpany[0]}&name=${condition.name[0]}&publishtime=${condition.publishtime[0]}&who=teacher">&nbsp;&nbsp;${i}&nbsp;</a>
                        </li>
                    </c:if>
                    <c:if test="${pb.currentPage != i}">
                        <li>
                            <a href="${pageContext.request.contextPath}/findStuByPageServlet?currentPage=${i}&rows=10&conpany=${condition.conpany[0]}&name=${condition.name[0]}&publishtime=${condition.publishtime[0]}&who=teacher">&nbsp;&nbsp;${i}&nbsp;</a>
                        </li>
                    </c:if>
                </c:forEach>
