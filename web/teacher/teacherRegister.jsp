...
<head>
    ...
    <script type="text/javascript">
        ...
        function validate1() {
            ...
            if (tnumber.value.length > 10 || tnumber.value.length < 4) {
            ...
            if (tpassword.value.length > 10 || tpassword.value.length < 6) {
                alert("密码长度应不少于6位，不多于10位！ ");
                return false;
            }
            if (tpassword.value != retpassword.value) {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" href="#">教师注册</a>
        ...
        <div class="container">
            <table class="table" style="position: relative;left: 0;width: 100%;">
                <tr>
                    <td>教师账号:</td>
                    <td>
                        <input type="text" value="${teacherAllInfo.tnumber}" name="tnumber" id="tnumber"
                               placeholder="请填写您的账号！" style="width:100%;" maxlength="15">
                    </td>
                </tr>
                <tr>
                    <td>教师姓名:</td>
                    <td>
                        <input type="text" value="${teacherAllInfo.tname}" name="tname" id="tname"
                               placeholder="请填写您的姓名！" style="width:100%;" maxlength="10">
                    </td>
                </tr>
                <tr>
                    <td>密码:</td>
                    <td>
                        <input type="password" name="tpassword" id="tpassword" placeholder="请填写您的密码！"
                ...
                <tr>
                    <td>确认密码:</td>
                    <td>
                        <input type="password" id="retpassword" placeholder="请再次确认您的密码！"
                               style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td>性别:</td>
                    <td>
                        <select name="tsex" value="" style="width:50%;">
                ...
                <tr>
                    <td>学校:</td>
                    <td>
                        <input type="text" value="${teacherAllInfo.tschool}" name="tschool" placeholder="请填写您的学校！"
                               style="width:100%;" maxlength="15">
                    </td>
                </tr>
                <tr>
                    <td>学院:</td>
                    <td>
                        <select name="tcollege" value="${teacherAllInfo.tcollege}" style="width:100%;">
                ...
                <tr>
                    <td>职称:</td>
                    <td>
                        <input type="text" value="${teacherAllInfo.ttitle}" name="ttitle" id="ttitle"
                               placeholder="请填写您的职称！" style="width:100%;" maxlength="40">
                    </td>
                </tr>
                <tr>
                    <td>联系方式:</td>
                    <td>
                        <input type="text" value="${teacherAllInfo.tphone}" name="tphone" placeholder="请填写您的联系方式！"
                               style="width:100%;" maxlength="11">
                    </td>
                </tr>
                <br>
            </table>
            <input type="submit" class="btn btn-primary" value="注册" style="position: relative;left:25%;"></input>
