...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link active" href="${pageContext.request.contextPath}/teacher/teacherIndex.jsp">首页<span class="sr-only">(current)</span></a>
    ...
    <div class="dropdown" style="padding-right: 4%">
        <c:if test="${user.tsex == '男' || empty uesr.tsex}">
            <img style="height: 37px" src="./image/boy.jpg">
        </c:if>
        <c:if test="${user.tsex == '女'}">
            <img style="height: 45px" src="./image/girl.jpg">
        </c:if>
...
<div style="margin-top: 200px;text-align: center;">
    <h2>${user.tname}老师，欢迎您使用协同育人平台</h2>
</div>
