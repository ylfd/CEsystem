    ...
    <div style="float:left;width: 85%;">
        ...
        <div class="container">
            <div style="float: left;margin-top: 20px">
                <form class="form-inline" action="${pageContext.request.contextPath}/teacherInfoListServlet"
                      method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tnumber" value="${condition.tnumber[0]}" class="form-control"
                               id="exampleInputName3">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail2">学院</label>
                        <input type="data" name="tcollege" value="${condition.tcollege[0]}" class="form-control"
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${pb.list}" var="t" varStatus="s">
                    <tr align="center">
                        ...
                        <th>${t.tphone}</th>
                        <th>
                            <input type="submit" value="修改" onclick="window.location.href = '${pageContext.request.contextPath}/returnOneTeacherInfoServlet?tid=${t.tid}'" style="border:1px solid rgb(154, 240, 154);">
        ...
        <div style="margin-left: 15%;margin-bottom: 10%">
            <nav aria-label="Page navigation">
                <ul class="pagination pagination-lg">
                    <li>
                        <a href="${pageContext.request.contextPath}/teacherInfoListServlet?currentPage=${pb.currentPage -1}&rows=10&tname=${condition.tname[0]}&tnumber=${condition.tnumber[0]}&tcollege=${condition.tcollege[0]}"
                           aria-label="Previous">
                    ...
                    <c:forEach begin="1" end="${pb.totalPage}" var="i">
                        <c:if test="${pb.currentPage == i}">
                            <li class="active">
                                <a style="color: #0f0f0f;" href="${pageContext.request.contextPath}/teacherInfoListServlet?currentPage=${i}&rows=10&tname=${condition.tname[0]}&tnumber=${condition.tnumber[0]}&tcollege=${condition.tcollege[0]}">&nbsp;&nbsp;${i}&nbsp;</a>
                            </li>
                        </c:if>
                        <c:if test="${pb.currentPage != i}">
                            <li>
                                <a href="${pageContext.request.contextPath}/teacherInfoListServlet?currentPage=${i}&rows=10&tname=${condition.tname[0]}&tnumber=${condition.tnumber[0]}&tcollege=${condition.tcollege[0]}">&nbsp;&nbsp;${i}&nbsp;</a>
                            </li>
                        </c:if>
                    </c:forEach>
